      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex h-16 items-center justify-between">
          ...
          <NavigationMenuList>
            {navigationItems.map((item) => (
              <NavigationMenuItem key={item.name}>
                {item.hasMegaMenu ? (
                  <>
                    <NavigationMenuTrigger className="bg-transparent hover:bg-transparent focus:bg-transparent data-[active]:bg-transparent data-[state=open]:bg-transparent dark:hover:bg-popover px-4 py-2 text-[14px] [font-variation-settings:'opsz'_32] transition-colors hover:text-primary focus:text-primary cursor-pointer">
                      {item.name}
                    </NavigationMenuTrigger>
                    <NavigationMenuContent>
                      <MegaMenu />
                  ...
                  <NavigationMenuLink
                    className="group inline-flex h-10 w-max items-center justify-center px-4 py-2 text-[14px] [font-variation-settings:'opsz'_32] transition-colors hover:text-primary focus:text-primary focus:outline-none cursor-pointer dark:hover:bg-popover dark:hover:rounded-md"
        ...
        <div className="hidden xl:flex items-center space-x-2">
          ...
          <Button variant="ghost" asChild className="cursor-pointer">
            <a href="https://lk.guestme.ru/" target="_blank" rel="noopener noreferrer">Вход в ЛК</a>
          </Button>
          <Button asChild className="cursor-pointer">
            <a href="https://lk.guestme.ru/registration" target="_blank" rel="noopener noreferrer">Регистрация</a>
          </Button>
        </div>
              ...
              <SheetHeader className="space-y-0 p-4 pb-2 border-b">
                <div className="flex items-center gap-2">
                  ...
                  <Image
                    ...
                    className="hidden dark:block"
                  />
                  <SheetTitle className="sr-only">GuestMe</SheetTitle>
